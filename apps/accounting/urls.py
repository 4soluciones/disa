...
urlpatterns = [
    ...
    path('cash-opening/save/', login_required(cash_opening_save), name='cash_opening_save'),
    path('cash-closing/calculate/', login_required(cash_closing_calculate), name='cash_closing_calculate'),
    path('cash-closing/save/', login_required(cash_closing_save), name='cash_closing_save'),
